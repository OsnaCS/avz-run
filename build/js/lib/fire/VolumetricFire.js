...
( function (root, factory) {
    ...
    var fs = [
        ...
        'vec3 color = sampleFire( texOut, vec4( 1.0, 2.0, 1.0, .5 ) ).xyz;',

        // fog support
        'float depth = (gl_FragCoord.z / gl_FragCoord.w)+10.0;',
        'depth = depth * fogDensity * 80.0;',
        'gl_FragColor = vec4( (color * 1.5 * 25.0 )/depth, 1.0/depth*80.0 );',
        '}',
    ...
    var initMaterial = (function () {
        ...
        return function () {
            ...
            material = new THREE.RawShaderMaterial({
                ...
                depthWrite: false, // prevents artifacts with smoke
                transparent: true,
                fog: true // enables fog
            });
